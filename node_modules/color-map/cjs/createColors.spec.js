...
test('match colormap output', function () {
    var actual = (0, index_js_1.createColors)([0, 0, 255], [0, 255, 128], 72);
...
test('Uses alpha in from/to', function () {
    var actual = (0, index_js_1.createColors)([0, 0, 0, .2], [1, 1, 1, .8], 2);
    expect(actual).toEqual([[0, 0, 0, .2], [1, 1, 1, .8]]);
});
test('alpha in from but not in to, will use alpha in from', function () {
    var actual = (0, index_js_1.createColors)([0, 0, 0, .2], [1, 1, 1], 2);
    expect(actual).toEqual([[0, 0, 0, .2], [1, 1, 1, .2]]);
});
test('alpha in `to` but not in `from`, will use alpha in `to`', function () {
    var actual = (0, index_js_1.createColors)([0, 0, 0], [1, 1, 1, .5], 2);
    expect(actual).toEqual([[0, 0, 0, .5], [1, 1, 1, .5]]);
});
test('match actual colors', function () {
    var actual = (0, index_js_1.createColors)([150, 0, 90], [0, 0, 200], 72, [0, 1]);
