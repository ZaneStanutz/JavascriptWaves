...
test('summer colors', function () {
    var summer = [{ index: 0, rgb: [0, 128, 102] }, { index: 1, rgb: [255, 255, 102] }];
    assertron_1.default.throws(function () { return (0, index_js_1.createColorsFromMap)(summer, 1); });
    var actual = (0, index_js_1.createColorsFromMap)(summer, 60);
...
//# sourceMappingURL=createColorsFromMap.spec.js.map